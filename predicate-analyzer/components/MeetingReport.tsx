...
export function MeetingReport({
  ...
  return (
    <section className="space-y-6 rounded-[2rem] border border-white/10 bg-[#303F4B] p-6 shadow-glow">
        ...
        <div className="space-y-5 rounded-[1.75rem] bg-[#E6DBBD] p-5 text-[#303F4B] print:bg-white">
                ...
                {workflow.meetingSummary.keyPoints.length > 0 ? (
                  workflow.meetingSummary.keyPoints.map((point) => (
                    <div
                      ...
                      className="rounded-xl bg-white px-3 py-2 text-sm leading-6"
                    >
          ...
          <div className="grid gap-4 lg:grid-cols-[0.9fr_1.1fr]">
                ...
                {workflow.segments.length > 0 ? (
                  workflow.segments.map((segment) => (
                    <div
                      ...
                      className="rounded-xl border border-[#303F4B]/10 bg-white px-3 py-2 text-sm leading-6"
                    >
            ...
            <div className="space-y-4">
              <div className="rounded-[1.75rem] border border-white/10 bg-white/50 p-4">
